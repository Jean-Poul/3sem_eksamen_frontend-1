      ...
      <div className="Countdown">
        <span className="Countdown-col">
          <span className="Countdown-col-element">
            <span className="ca3Green">{this.addLeadingZeros(countDown.days)}</span>
        ...
        <span className="Countdown-col">
          <span className="Countdown-col-element">
            <span className="ca3Green">{this.addLeadingZeros(countDown.hours)}</span>
        ...
        <span className="Countdown-col">
          <span className="Countdown-col-element">
            <span className="ca3Lime">{this.addLeadingZeros(countDown.min)}</span>
        ...
        <span className="Countdown-col">
          <span className="Countdown-col-element">
            <span className="ca3Green">{this.addLeadingZeros(countDown.sec)}</span>
